#include "OrthagonalDeltaSolution.h"
#include <fastmath.h>
#include "checksumm.h"
...
OrthagonalDeltaSolution::OrthagonalDeltaSolution(Config* config)
{
...
void OrthagonalDeltaSolution::init() {
    ...
    DELTA_TOWER1_X = -DELTA_RADIUS; // front left tower
    DELTA_TOWER1_Y = 0.0F;

    DELTA_TOWER2_X = DELTA_RADIUS; // front right tower
    DELTA_TOWER2_Y = 0.0F;
...
void OrthagonalDeltaSolution::cartesian_to_actuator( float cartesian_mm[], float actuator_mm[] )
{
...
void OrthagonalDeltaSolution::actuator_to_cartesian( float actuator_mm[], float cartesian_mm[] )
{
...
bool OrthagonalDeltaSolution::set_optional(const arm_options_t& options) {
...
bool OrthagonalDeltaSolution::get_optional(arm_options_t& options) {
